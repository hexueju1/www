...
- (void)visitSource
{
    ...
    if (request.URL.host) {
        ...
        [self loadLocalHtmlWithRequest:request];
//        origin here
// file:///var/containers/Bundle/Application/544E9389-5060-49C4-89E1-0D956271C4B7/oneday.app/./assets/index.html
//        [_webView loadFileURL:request.URL allowingReadAccessToURL:request.URL];
    }
}
//stringPath    __NSCFString *    @"file:///Users/zhangjin.yan/Library/Developer/CoreSimulator/Devices/1DC2ABB5-6352-4B9E-8A84-26F3CCF66C87/data/Containers/Bundle/Application/5B48A62C-7A38-4934-97F9-F25FE297AA88/oneday.app/./assets/index_en.html%3Ft=1562071104057"    0x0000600003575200
-(void) loadLocalHtmlWithRequest:(NSURLRequest*) request {
    NSString* stringPath =request.URL.absoluteString;
    ...
    NSString* resourceName = arr[0];
    NSString* extension = @"html";
//    NSArray *arrExtension = [extension componentsSeparatedByString:@"?"];
//    extension = arrExtension[0];
    NSURL* filePath=[[NSBundle mainBundle] URLForResource:resourceName withExtension:extension];
 ...
 */
 ...
 decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler
 {
  ...
  if (_onShouldStartLoadWithRequest) {
      if ([(request.URL).absoluteString containsString:@"https://www.tradingview.com"]) {
...
thenCall: (void (^)(NSString*)) callback
{
  [self.webView evaluateJavaScript: js completionHandler: ^(id result, NSError *error) {
    ...
    RCTLogInfo(@"JS: %@", js); //add
    RCTLogInfo(@"Error: %@", [error localizedDescription]); //add
